          ...
          <header className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-4 pb-6 border-b border-emerald-900/40">
            ...
            <div className="flex items-center gap-2.5 flex-wrap w-full lg:w-auto">
              <button
                ...
                className="px-4 py-2.5 rounded-xl bg-gradient-to-r from-emerald-500 to-teal-500 hover:from-emerald-400 text-white text-xs font-bold flex items-center gap-1.5 shadow-lg shadow-emerald-500/25 transition-transform active:scale-95"
              >
                <Plus className="w-4 h-4" />
                <span>+ 전화/현장 예약 등록</span>
              </button>
              ...
              <button
                ...
                className="p-2.5 rounded-xl bg-slate-900 hover:bg-red-950/40 border border-slate-700 hover:border-red-500/40 text-slate-400 hover:text-red-300 transition-colors"
                title="로그아웃"
              >
